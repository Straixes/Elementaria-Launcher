...
public class PanelManager {
    ...
    public void init() {
        this.stage.setTitle("Elementaria Launcher");
        ...
        if (Platform.isOnLinux()) {
            ...
            topPaneContraints.setMinHeight(38);
            topPaneContraints.setMaxHeight(38);
